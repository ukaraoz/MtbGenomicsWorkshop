...
**Updated June 2018 by** `Ulas Karaoz <https://eesa.lbl.gov/profiles/ulas-karaoz/>`__

Credits
----------

**Original authors**: *Jessica Mizzi, Titus Brown, and Lisa K. Johnson at*  
`Lab for Data Intensive Biology <http://ivory.idyll.org/dibsi/>`__ (http://dib-training.readthedocs.io/en/pub/2016-01-13-adv-beg-shell.html)
...
to write the rename command, which is ``mv``::
...
.. info:: You may see **backquotes** also called **backticks** ("`") used instead of `$(...)`. Same thing.
...
Most prompts support `readline-style` editing. This uses `emacs <https://www.tldp.org/HOWTO/pdf/Emacs-Beginner-HOWTO.pdf>`_ control keys (`emacs` is a very powerful editor, tough with a bit of steep learning curve)
...
but what is the `[ ]` notation?  That's actually running
...
How would you copy all files containing a specific string
